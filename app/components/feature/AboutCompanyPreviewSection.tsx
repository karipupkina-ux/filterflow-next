            ...
            <div>
              ...
              <div className="mt-6 space-y-5 text-[16px] leading-[1.75] text-slate-600 md:text-[17px]">
                <p>
                  ...
                  рукавов для систем аспирации и пылеудаления. Наше собственное
                  производство позволяет контролировать качество на каждом этапе и
                  изготавливать продукцию по индивидуальным размерам.
                </p>
