    ...
    <section className="relative h-[760px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col px-6 pb-12 pt-[120px]">
        <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center text-center">
          ...
          >
            Производство качественных мешков для аспирации (верхние и нижние),
            тканевые мешки для стружкоотсосов, мешки для систем аспирации и УВП.
            Фильтровальные рукава любых размеров — цена от производителя.
            Индивидуальные размеры, быстрое изготовление, доставка по России и СНГ.
          </p>
