...
export const metadata: Metadata = pageMetadata({
  title: "Портфолио фильтровальных мешков и рукавов",
  description:
    "Примеры изготовленных фильтровальных мешков и рукавов для стружкоотсосов, циклонов и УВП. Работы по размерам, образцам и чертежам заказчиков.",
  path: "/portfolio",
});
