          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mb-8 max-w-[620px] text-[16px] leading-[1.7] text-[#5b677a]">
                ...
                размерам заказчика. Любые формы, конфигурации и материалы под
                ваше оборудование.
              </p>
          ...
          <div className="mx-auto max-w-[1080px] px-6">
            ...
            <div className="mx-auto max-w-[980px] space-y-8 text-[16px] leading-[1.75] text-[#475569] sm:text-[17px]">
              ...
              <p>
                ...
                любыми конструктивными особенностями.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="mx-auto max-w-[1360px]">
              ...
              <div className="max-w-[1380px] space-y-7 text-[16px] leading-[1.7] text-[#334155] sm:text-[17px]">
                ...
                <p>
                  ...
                  , с длительным сроком службы и высокой степенью очистки
                  воздуха.
                </p>
