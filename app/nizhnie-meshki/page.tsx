...
export default function NizhnieMeshkiPage() {
  ...
  const faqItems = [
    {
      question: "Какой объём нижнего мешка выбрать для стружкоотсоса?",
      answer:
        "Объём нижнего мешка зависит от интенсивности работы и типа оборудования. Для домашних мастерских подойдут мешки 50-100 литров, для небольших производств — 100-200 литров, для промышленных систем — 200-300 литров. Чем больше объём, тем реже нужно опустошать мешок.",
    },
    {
      question: "Как часто нужно менять нижний мешок для аспирации?",
      answer:
        "Нижний мешок не требует частой замены — он служит 2-3 года при правильной эксплуатации. Опустошать мешок нужно по мере заполнения (обычно раз в неделю при интенсивной работе). Замена требуется только при износе ткани или повреждении швов.",
    },
    {
      question: "Можно ли стирать нижний мешок для стружкоотсоса?",
      answer:
        "Да, нижние мешки из полиэстера и полипропилена можно стирать в тёплой воде с мягким моющим средством. После стирки мешок нужно полностью высушить перед установкой. Стирка продлевает срок службы мешка и улучшает его внешний вид.",
    },
    {
      question: "Чем отличается нижний мешок от верхнего?",
      answer:
        "Нижний мешок — это накопительный элемент для сбора крупной стружки и опилок. Он не фильтрует воздух, а только собирает отходы. Верхний мешок — это фильтровальный элемент, который очищает воздух от мелкой пыли перед выбросом. В системе аспирации они работают вместе.",
    },
    {
      question: "Как правильно установить нижний мешок на стружкоотсос?",
      answer:
        "Установка зависит от типа крепления: хомутовое крепление — надеть мешок на патрубок и затянуть хомут; кольцевое крепление — вставить кольцо в горловину мешка и закрепить на патрубке; резинка — просто натянуть мешок на патрубок. Важно обеспечить герметичность соединения.",
    },
  ];
      ...
      <main className="min-h-screen bg-[#f8fafc]">
            ...
            <div className="grid items-start gap-10 lg:grid-cols-[1.02fr_0.98fr]">
              <div className="max-w-[520px] overflow-hidden rounded-[24px] bg-[#eef2f5]">
                <img
                  ...
                  alt="Нижние мешки для аспирации"
              ...
              <div>
                <p className="text-[18px] leading-8 text-[#334155]">
                  ...
                  накопительные мешки, которые устанавливаются в нижней части
                  стружкоотсоса для сбора отфильтрованных опилок, стружки и пыли.
                  Они обеспечивают удобный сбор и утилизацию отходов производства.
                </p>

                <h2 className="mt-10 mb-6 text-[28px] font-bold leading-tight text-[#0f172a] md:text-[32px]">
                  Преимущества нижних мешков
                </h2>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
                ...
                <p className="text-[15px] leading-7 text-[#475569]">
                  Универсальные мешки для большинства систем аспирации. Объем от 50 до 200 литров.
                </p>
              </div>
              ...
              <div className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
                ...
                <p className="text-[15px] leading-7 text-[#475569]">
                  Для тяжелых условий эксплуатации. Двойные швы и усиленное дно.
                </p>
              </div>
              ...
              <div className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md">
                ...
                <p className="text-[15px] leading-7 text-[#475569]">
                  Позволяют контролировать уровень заполнения без снятия мешка.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-9 text-center">
              ...
              <p className="mx-auto max-w-4xl text-[16px] leading-8 text-[#475569] md:text-[17px]">
                Найдите свою модель и узнайте точные размеры нижнего накопительного мешка.
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="max-w-[1280px]">
              <h2 className="text-[24px] font-bold leading-[1.18] text-[#0f2341] md:text-[42px]">
                Нижние мешки для аспирации — назначение и особенности
              </h2>

              <div className="mt-6 space-y-5 text-[15px] leading-8 text-[#334155] md:text-[16px]">
                <p>
                  <strong className="font-semibold text-[#0f2341]">Нижний мешок для аспирации</strong> — это накопительный элемент системы аспирации, который устанавливается в нижней части стружкоотсоса или циклонной установки. Его основная функция — сбор крупной стружки, опилок и других отходов производства, прошедших через систему фильтрации.
                </p>

                <p>
                  В отличие от верхнего (фильтровального) мешка, нижний мешок не фильтрует воздух, а служит накопительным бункером. Он должен быть достаточно прочным, чтобы выдерживать вес накопленных отходов, и иметь удобную систему крепления для быстрой замены и опустошения.
                </p>

                <div className="pt-1">
                  <p className="mb-4 text-[15px] leading-8 text-[#334155] md:text-[16px]">
                    Ключевые характеристики нижних мешков для аспирации:
                  </p>
                ...
                <p>
                  Мы производим <strong className="font-semibold text-[#0f2341]">нижние мешки для аспирации по индивидуальным размерам</strong> под любое оборудование. Минимальный заказ — от 1 штуки. Срок изготовления — от 3 рабочих дней. Доставка по всей России.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="rounded-[28px] bg-[#f4f6f8] px-8 py-10 md:px-10 md:py-12">
              <div className="max-w-[1240px]">
                <h2 className="text-[23px] font-bold leading-[1.18] text-[#0f2341] md:text-[40px]">
                  Как правильно выбрать нижний мешок для стружкоотсоса
                </h2>

                <div className="mt-6 space-y-5 text-[15px] leading-8 text-[#334155] md:text-[16px]">
                  <p>
                    Для правильного подбора нижнего мешка необходимо знать модель стружкоотсоса или точные размеры: диаметр горловины и высоту мешка. Нижний мешок должен точно соответствовать размерам нижнего патрубка оборудования, иначе возможны потери отходов и снижение эффективности системы.
                  </p>
                  ...
                  <p>
                    Если вы не знаете точные размеры — пришлите фотографию оборудования или его модель, и наши специалисты бесплатно подберут подходящий нижний мешок для аспирации.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white pb-24">
          <div className="mx-auto max-w-7xl px-6">
            <div className="max-w-[1280px]">
              <h2 className="text-[24px] font-bold leading-[1.18] text-[#0f2341] md:text-[42px]">
                Купить нижние мешки для аспирации от производителя
              </h2>

              <div className="mt-6 space-y-5 text-[15px] leading-8 text-[#334155] md:text-[16px]">
                <p>
                  FilterFlow — производитель <strong className="font-semibold text-[#0f2341]">нижних мешков для аспирации</strong> с собственным производством. Мы изготавливаем <strong className="font-semibold text-[#0f2341]">накопительные мешки для стружкоотсосов</strong>, <strong className="font-semibold text-[#0f2341]">нижние мешки для циклонных установок</strong>, а также <strong className="font-semibold text-[#0f2341]">нестандартные мешки по чертежам заказчика</strong>.
                </p>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-9 text-center">
              <h2 className="mb-3 text-[24px] font-bold leading-[1.15] text-white md:text-[34px]">
                Заказать нижний мешок для аспирации
              </h2>
