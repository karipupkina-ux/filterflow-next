    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="mb-12 text-center">
          ...
          <h2 className="mb-4 text-4xl font-bold">
            Виды мешков для систем аспирации
          </h2>

          <p className="mx-auto max-w-2xl text-gray-500">
            Верхние и нижние фильтровальные мешки, тканевые решения и мешки для
            УВП и циклонов — под ваше оборудование
          </p>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">
              Почему мешки для аспирации заказывают у FilterFlow
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Собственное производство фильтровальных мешков — контроль качества
              и сроков на каждом этапе
            </p>
          </div>
      ...
      <section className="bg-[#f8fafc] py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">
              Где нужны мешки для аспирации и пылеулавливания
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Промышленная фильтрация на деревообработке, в мебельном производстве
              и на пылеулавливающих установках
            </p>
          </div>
      ...
      <section className="bg-[#f8fafc] py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">
              Фильтры для аспирации: фильтровальные материалы
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Ткани и нетканые материалы с заданной степенью удержания пыли — под
              вашу задачу
            </p>
          </div>
      ...
      <section className="bg-[#f8fafc] py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">
              Размеры мешков для аспирационных установок
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Стандартные модели и индивидуальный пошив под чертёж — для
              стружкоотсосов, УВП и циклонов
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-14">
          <div className="max-w-[620px] text-white">
            ...
            <h2 className="mb-7 text-[44px] font-bold leading-[1.12] tracking-[-0.02em] md:text-[58px]">
              Мешки для аспирации на заказ — расчёт стоимости
            </h2>

            <p className="mb-10 max-w-[620px] text-[18px] leading-[1.7] text-white/90 md:text-[19px]">
              Оставьте заявку — уточним тип мешка и оборудование, свяжемся в течение
              30 минут и рассчитаем стоимость.
            </p>
      ...
      <section className="bg-[#f8fafc] py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-5xl">
              Сопутствующие решения: рукава и мешки
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Рукавный фильтр для аспирации и смежная продукция — в каталоге
              FilterFlow
            </p>
          </div>
          ...
          <div className="mb-10 flex flex-col gap-6 md:mb-12 md:flex-row md:items-start md:justify-between">
            <div className="max-w-[760px]">
              ...
              <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-[54px] md:leading-[1.08]">
                Статьи: мешки для аспирации и фильтрация
              </h2>
            </div>
        ...
        <div className="mx-auto max-w-[1120px] px-6">
          <div className="mb-10 text-center md:mb-12">
            ...
            <h2 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 md:text-[56px] md:leading-[1.08]">
              Вопросы о мешках для аспирации
            </h2>

            <p className="mx-auto max-w-3xl text-[15px] leading-7 text-slate-500 md:text-[16px]">
              Подбор под стружкоотсос или УВП, сроки и доставка фильтровальных
              мешков
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-[28px] bg-[#f4f6f8] px-8 py-10 md:px-12 md:py-12">
            <h2 className="mb-7 text-[34px] font-bold leading-[1.12] tracking-[-0.02em] text-slate-900 md:text-[58px]">
              Что такое мешки для аспирации и где они применяются
            </h2>
            ...
            <div className="space-y-6 text-[17px] leading-[1.75] text-slate-700 md:text-[18px]">
              <p>
                ...
                — фильтровальные мешки, которые устанавливают в линии аспирации
                и на локальные установки: они удерживают пыль и частицы при
                промышленной фильтрации воздуха. Такие элементы ставят в узлах
                пылеулавливания на станках, в вытяжках и бункерах — чтобы воздух
                в цеху оставался чище, а оборудование не забивалось опилками и
                стружкой.
              </p>
              ...
              <p>
                ...
                Оба элемента нужны для устойчивой работы системы; при заказе
                важно указать диаметр, высоту и тип крепления.
              </p>
      ...
      <section className="bg-[#f8fafc] py-6 md:py-8">
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-[28px] bg-[#f4f6f8] px-8 py-10 md:px-12 md:py-12">
            <h2 className="mb-7 text-[34px] font-bold leading-[1.12] tracking-[-0.02em] text-slate-900 md:text-[58px]">
              Как подобрать мешки для аспирации под оборудование
            </h2>
      ...
      <section className="bg-[#f8fafc] py-6 pb-16 md:py-8 md:pb-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="px-0 py-2">
            <h2 className="mb-7 text-[34px] font-bold leading-[1.12] tracking-[-0.02em] text-slate-900 md:text-[58px]">
              Мешки для аспирации: заказ у производителя
            </h2>
            ...
            <div className="max-w-[1320px] space-y-6 text-[17px] leading-[1.75] text-slate-700 md:text-[18px]">
              <p>
                ...
                с собственным цехом. Выпускаем верхние и нижние мешки для
                стружкоотсосов, тканевые мешки, изделия для УВП и циклонов, а
                также нестандартные фильтровальные мешки по чертежам — по точным
                размерам, без подбора «с запасом». Купить мешки для аспирации у
                производителя выгодно при партиях от одной штуки: короткие сроки
                и прямые цены.
              </p>
