        ...
        >
          <div className="mx-auto flex min-h-[600px] max-w-[1440px] flex-col items-center justify-start px-4 pb-16 pt-20 sm:min-h-[680px] sm:px-6 sm:pb-20 sm:pt-24 md:pt-28 lg:min-h-[760px] lg:pb-24 lg:pt-40 xl:pt-44">
            <div className="flex w-full max-w-[980px] flex-col items-center gap-6 text-center text-white lg:gap-8">
              ...
              <h1 className="max-w-[920px] text-[30px] font-bold leading-[1.12] tracking-[-0.03em] [text-shadow:0_2px_28px_rgba(0,0,0,0.55)] sm:text-[38px] md:text-[48px] lg:text-[52px] md:leading-[1.08]">
              ...
              <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-[13px] text-white sm:gap-x-8 sm:gap-y-3 sm:text-[14px] md:text-[15px] [text-shadow:0_1px_10px_rgba(0,0,0,0.5)]">
