...
const applicationItems = [
  ...
  "Фиксация фильтровальных рукавов на циклонах",
  "Установки вентиляции и пылеудаления (УВП)",
  "Рукавные фильтры промышленных предприятий",
  "Деревообрабатывающее оборудование",
  "Системы очистки воздуха на производстве",
];
      ...
      <main id="top" className="bg-[#f8fafc]">
            ...
            <div className="grid items-center gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14">
              <div className="max-w-[560px] pt-[94px] md:pt-[108px]">
                ...
                <p className="mt-8 max-w-[560px] text-[15px] leading-[1.72] text-[#475569] md:text-[16px]">
                  Металлические быстросъёмные хомуты для крепления фильтровальных
                  мешков. Нержавеющая сталь и оцинковка. Диаметры от 100 до 800
                  мм. Быстрый монтаж и демонтаж. Производство FilterFlow.
                </p>
                ...
                <div className="w-full max-w-[690px] rounded-[28px] bg-white p-4 shadow-[0_20px_50px_rgba(15,23,42,0.07)]">
                  <div className="flex min-h-[320px] items-center justify-center overflow-hidden rounded-[22px] bg-[#f6f7f9] md:min-h-[450px]">
                    <img
                      ...
                      alt="Быстросъёмные хомуты для фильтровальных мешков"
          ...
          <div className="mx-auto grid max-w-[1280px] gap-8 lg:grid-cols-[1fr_0.95fr] lg:gap-12">
            <div className="pt-1">
              <h2 className="max-w-[620px] text-[28px] font-bold leading-[1.08] tracking-[-0.03em] text-[#10233f] md:text-[38px]">
                Применение быстросъёмных хомутов для фильтров
              </h2>

              <div className="mt-7 max-w-[670px] space-y-7 text-[15px] leading-[1.78] text-[#475569] md:text-[16px]">
                <p>
                  Быстросъемные хомуты — это специализированные крепёжные элементы
                  для фиксации фильтровальных мешков и рукавов на промышленном
                  оборудовании. Они обеспечивают герметичное соединение и позволяют
                  быстро производить замену фильтрующих элементов без использования
                  дополнительного инструмента.
                </p>

                <p>
                  Хомуты применяются для крепления мешков к патрубкам аспирационных
                  систем, фланцам циклонов, установкам вентиляции и пылеудаления
                  (УВП), рукавным фильтрам и другому промышленному оборудованию.
                </p>
              </div>
            </div>

            <div className="rounded-[28px] bg-[#eef7f5] px-8 py-8 md:px-10 md:py-9">
              <h3 className="max-w-[560px] text-[22px] font-bold leading-[1.2] tracking-[-0.02em] text-[#10233f] md:text-[28px]">
                Области применения хомутов для фильтровальных мешков
              </h3>
          ...
          <div className="mx-auto max-w-[1280px]">
            <div className="max-w-[1240px]">
              ...
              <div className="mt-8 space-y-7 text-[15px] leading-[1.72] text-[#334155] md:text-[16px]">
                <p>
                  Быстросъёмные хомуты — это специализированные крепёжные элементы для надёжной фиксации фильтровальных мешков и рукавов на промышленном оборудовании. Они обеспечивают герметичное соединение и позволяют быстро производить замену фильтрующих элементов без использования дополнительного инструмента.
                </p>

                <p>
                  Мы производим металлические хомуты из <strong>нержавеющей стали AISI 304/316 и оцинкованной стали</strong> с диаметрами от 100 до 800 мм. Все изделия изготавливаются по индивидуальным параметрам оборудования и проходят контроль качества перед отправкой.
                </p>
          ...
          <div className="mx-auto max-w-[1280px]">
            <div className="rounded-[28px] bg-[#f1f5f9] px-8 py-9 md:px-12 md:py-12">
              ...
              <p className="mt-8 max-w-[1160px] text-[15px] leading-[1.72] text-[#334155] md:text-[16px]">
                Для деревообрабтывающих предприятий обычно используются оцинкованные хомуты, для химической промышленности и влажных сред — нержавеющая сталь. Если размеры неизвестны, отправьте фото оборудования или параметры патрубка — мы подберём хомут под вашу систему.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 pb-16 md:pb-18">
          <div className="mx-auto max-w-[1280px]">
            <div className="max-w-[1240px]">
              <h2 className="text-[28px] font-bold leading-[1.15] tracking-[-0.03em] text-[#10233f] md:text-[36px]">
                Хомуты для крепления фильтровальных мешков на циклоны и аспирационные системы
              </h2>

              <div className="mt-8 space-y-7 text-[15px] leading-[1.72] text-[#334155] md:text-[16px]">
                <p>
                  Наши <strong>быстросъёмные хомуты для фильтровальных мешков</strong> подходят для крепления мешков на циклоны, аспирационные системы, установки вентиляции и пылеудаления (УВП) и рукавные фильтры. Мы изготавливаем хомуты для аспирационных систем, металлические хомуты для промышленных фильтров, а также хомуты для крепления рукавов на патрубки.
                </p>

                <p>
                  В каталоге можно найти <strong>хомуты для деревообрабтывающих станков, металлообработки, пищевой промышленности, химической промышленности</strong>. Все изделия изготовлены из <strong>нержавеющей стали AISI 304/316 и оцинкованной стали</strong>, с длительным сроком службы и надёжной фиксацией.
                </p>

                <p>
                  Мы выполняем <strong>индивидуальные заказы на хомуты для фильтровальных мешков</strong> и доставку по всей России: Москва, Санкт-Петербург, Екатеринбург, Казань и другие города.
                </p>
              </div>
          ...
          <div className="mx-auto max-w-[1280px]">
            <div className="mx-auto max-w-[980px] text-center">
              <h2 className="text-[30px] font-bold leading-[1.15] tracking-[-0.03em] text-[#10233f] md:text-[42px]">
                Заказать быстросъёмные хомуты
              </h2>

              <p className="mx-auto mt-5 max-w-[900px] text-[15px] leading-[1.7] text-[#475569] md:text-[16px]">
                Заполните форму, и мы свяжемся с вами в ближайшее время для уточнения деталей заказа
              </p>
            </div>
